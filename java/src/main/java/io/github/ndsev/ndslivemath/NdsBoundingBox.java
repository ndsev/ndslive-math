 ...
 *
 * <p>NDS coordinates use integers for fast comparisons: X (longitude) is a
 * 32-bit signed value and Y (latitude) is a 31-bit signed value. Values are
 * held in {@code long}s so the full signed range is representable.</p>
 *
 * <p>Faithful port of {@code python/src/ndslive/math/bounding_box.py}.</p>
 */
public final class NdsBoundingBox {
    ...
    /**
     * @param minX SW corner longitude
     * @param minY SW corner latitude
     * @param maxX NE corner longitude
     * @param maxY NE corner latitude
     */
     ...
     *
     * @param tileId a tile id value (signed int32 or unsigned)
     * @return an NdsBoundingBox covering the tile's area
     */
    ...
    public boolean equals(Object obj) {
        ...
        return this.minX == o.minX && this.minY == o.minY
                && this.maxX == o.maxX && this.maxY == o.maxY;
    }
    ...
    public String toString() {
        return "NdsBoundingBox(minX=" + minX + ", minY=" + minY
                + ", maxX=" + maxX + ", maxY=" + maxY + ")";
    }
}
