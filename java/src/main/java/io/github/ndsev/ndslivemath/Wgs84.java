 ...
 *
 * <p>Provides methods for coordinate conversion, normalization, and distance
 * calculations. This is an idiomatic Java port of the Python reference
 * implementation in {@code python/src/ndslive/math/wgs84.py}.</p>
 *
 * <p>Coordinates are stored in degrees: {@link #x} is longitude, {@link #y} is
...
public final class Wgs84 {
     ...
     *
     * @param lon longitude in degrees, wrapped into {@code [-180, 180)}
     * @param lat latitude in degrees, clamped into {@code [-90, 90)}
     */
     ...
     * {@code [-90, 90)}. Called automatically by the constructors; call
     * explicitly after mutating {@link #x} or {@link #y} directly.
     */
     ...
     *
     * <p>Uses {@link Math#floor} (not truncation), as recommended by NDS for
     ...
     * Inverse of {@link #toNdsCoordinates()}.
     *
     ...
     * @param atLatitude the latitude where the measurement is taken
     ...
     *
     * @param other another WGS84 point
     ...
     *
     * @param other another WGS84 point — the starting point
