 ...
 *
 * <p>The code is a 64-bit unsigned value stored in a {@code long}. Java has no
 ...
 * read it and {@link Long#toUnsignedString(long)} to print it.</p>
 *
 * <p>Faithful port of {@code python/src/ndslive/math/morton.py}.</p>
 */
public final class MortonCode {
     ...
     *
     * @param mortonCode the 64-bit Morton (Z-order) code value
     */
     ...
     *
     * @param x NDS longitude (signed 32-bit integer); wrapped if out of range
     * @param y NDS latitude (signed 31-bit integer); wrapped if out of range
     ...
     * Inverse of {@link #fromNdsCoordinates(long, long)}.
     *
